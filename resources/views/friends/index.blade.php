			...
			<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
				@for ($i = 9; $i <= 20; $i++)
					<a href="#" class="group flex flex-col items-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg hover:shadow-lg transition-shadow">
						<img class="w-20 h-20 rounded-full object-cover ring-2 ring-blue-500/20 group-hover:ring-blue-500/40" src="https://i.pravatar.cc/150?img={{ $i }}" alt="Avatar sugerencia {{ $i }}">
						<span class="mt-2 text-sm font-medium text-gray-900 dark:text-white">Usuario {{ $i }}</span>
						<span class="text-xs text-gray-500 dark:text-gray-400">{{ rand(1, 30) }} libros</span>
